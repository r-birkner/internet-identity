...
export const features = {
  FETCH_ROOT_KEY: import.meta.env.VITE_II_FETCH_ROOT_KEY === "1",
  DUMMY_AUTH: import.meta.env.VITE_II_DUMMY_AUTH === "1",
  DUMMY_CAPTCHA: import.meta.env.VITE_II_DUMMY_CAPTCHA === "1",
};
